            ...
            try:
                ...
                # if not row[0]=='':
                    ...
                    html_lines = {"list": "\n\t\t\t\t<li>{TEXT}</li>",
                                ...
                                "insButton": "\n\t\t<button class = \"rhbutton alertbutton\" onclick=\" window.open('{LINK}', '_blank'); return false;\">{TEXT}</button>",
                    ...
                    elif "paragraph" in type:
                        html = html_lines["paragraph"].format(TEXT=value)
                    else:
                        html = value
